...
<html>
    ...
    <body class="bg-light">
        ...
        <main role="main" class="container">
            ...
            <section>
                <form action="StreamersFirmwareReport.php">
            ...
            <section>
                <form action="utlis/exportToExcel.php" method="post" class="m-0 row">
                    <input type="hidden" name="table_data" value='<?= json_encode($data) ?>'/>
                    <input type="submit" class="btn btn-outline-success" value="Export" <?php echo empty($data) ?  'disabled' : '' ?>/>
                </form>
            </section>
        </main>
        <footer></footer>
